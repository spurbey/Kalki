...
const coordinatorInstructions = [
  ...
  "Use the preloaded Kalki browser research tools for reconnaissance; never use raw Playwright tools or deferred tool discovery.",
  ...
  "During exploration, inspect one representative page with the compact research tools, persist physical capture under research/captures/, and immediately record findings in task.md under ## Exploration Findings.",
  "Maintain task.md as a living blackboard: update findings immediately upon inspecting each source, record schema tables under ## Implementation upon registration, and record operator contracts upon authoring; canonical hashing preserves approvals across updates.",
